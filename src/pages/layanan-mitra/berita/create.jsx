          ...
          <div>
            ...
            {thumbnailPreviewUrl && (
              <div className="mt-4 max-w-xs">
                <p className="text-xs font-bold text-slate-500 mb-2">Pratinjau Foto Utama (Rasio 16:9):</p>
                <div className="relative border rounded p-1 bg-gray-50 flex flex-col justify-between">
                  <img src={thumbnailPreviewUrl} alt="Thumbnail Preview" className="w-full aspect-video object-cover rounded" />
                  <button
                    type="button"
