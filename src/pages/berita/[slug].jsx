                ...
                <article className="max-w-3xl mx-auto bg-white rounded-xl shadow-sm border border-gray-100 p-4 sm:p-6 lg:p-8 min-w-0 overflow-hidden py-8 px-4 sm:px-6 lg:px-8">
                  ...
                  <div
                    className="
                      ...
                      prose prose-lg max-w-none break-words whitespace-normal text-justify [&>*]:!word-break-normal [&>*]:!overflow-wrap-normal font-sans text-gray-800 leading-relaxed prose-serif-title
