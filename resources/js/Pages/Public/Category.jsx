...
export default function Category({ category, posts }) {
    const { global_categories } = usePage().props;

    return (
        <PublicLayout>
            <Head title={`${category.name} - PojokTV`}>
            ...
            <div className="w-full max-w-7xl mx-auto px-4 py-8">
                ...
                <div className="mb-8 pb-4 border-b-4 border-red-600">
                    ...
                    <p className="text-gray-500 text-sm mt-2 ml-5">
                        {posts.length > 0
                            ? `${posts.length} artikel tersedia di rubrik ini`
                                ...
                                {posts[0] && (
                                    <article className="border-b border-gray-200 pb-6">
                                        ...
                                        <div className="flex items-center gap-3 text-xs text-gray-400">
                                            ...
                                            <span>•</span>
                                            <span><i className="fa-regular fa-clock mr-1"></i>Baru saja</span>
                                            <span>•</span>
                                ...
                                {posts.slice(1).map(post => (
                                    <article key={post.id} className="flex gap-4 border-b border-gray-100 pb-5 group">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <span className="inline-block text-red-600 text-[10px] font-bold uppercase mb-1">
                                                {post.category}
                                            </span>
                                            <Link href="#">
